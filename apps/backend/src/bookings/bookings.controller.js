...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Get all bookings for current user' }),
...
__decorate([
    ...
    (0, common_1.Get)(':id'),
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_1.ApiOperation)({ summary: 'Get a single booking' }),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
...
__decorate([
    ...
    (0, common_1.Put)(':id'),
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_1.ApiOperation)({ summary: 'Update/Reschedule a booking' }),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
    __param(1, (0, common_1.Param)('id')),
